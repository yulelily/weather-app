...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(/*! ./clem-onojeghuo-zlABb6Gke24-unsplash.jpg */ "./src/clem-onojeghuo-zlABb6Gke24-unsplash.jpg"), __webpack_require__.b);
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
___CSS_LOADER_EXPORT___.push([module.id, "@import url(https://fonts.googleapis.com/css2?family=Jost&display=swap);"]);
...
.body {
    ...
    grid-template-columns: minmax(20vw, 300px) 1fr minmax(20vw, 400px);
}
...
.forecast-info {
    ...
    gap: 32px;
}`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AACA;IACI,UAAU;IACV,SAAS;AACb;;AAEA;IACI,iBAAiB;IACjB,yDAAkE;IAClE,sBAAsB;IACtB,yBAAyB;IACzB,+BAA+B;IAC/B,iBAAiB;IACjB,gBAAgB;IAChB,qCAAqC;;IAErC,aAAa;IACb,kCAAkC;IAClC,kEAAkE;AACtE;;AAEA;IACI,WAAW;IACX,kBAAkB;;IAElB,aAAa;AACjB;;AAEA;;IAEI,aAAa;IACb,YAAY;IACZ,uBAAuB;IACvB,mBAAmB;AACvB;;AAEA;IACI,gBAAgB;IAChB,SAAS;AACb;;AAEA;IACI,eAAe;IACf,YAAY;IACZ,aAAa;IACb,8BAA8B;;IAE9B,cAAc;IACd,mBAAmB;IACnB,oBAAoB;IACpB,kBAAkB;AACtB;;AAEA;IACI,YAAY;IACZ,aAAa;IACb,cAAc;IACd,mBAAmB;IACnB,iBAAiB;AACrB;;AAEA;IACI,eAAe;IACf,cAAc;IACd,YAAY;AAChB;;AAEA;IACI,gBAAgB;AACpB;;AAEA;IACI,eAAe;AACnB;;AAEA;;;;;IAKI,eAAe;AACnB;;AAEA;IACI,kBAAkB;AACtB;;AAEA;IACI,iBAAiB;AACrB;;AAEA;;IAEI,YAAY;IACZ,cAAc;IACd,mBAAmB;IACnB,iBAAiB;IACjB,YAAY;AAChB;;AAEA;;IAEI,wBAAwB;AAC5B;;AAEA;IACI,WAAW;IACX,kBAAkB;IAClB,YAAY;IACZ,aAAa;IACb,qBAAqB;IACrB,qBAAqB;AACzB;;AAEA;IACI,kBAAkB;AACtB;;AAEA;IACI,gBAAgB;AACpB;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,eAAe;IACf,kBAAkB;;IAElB,aAAa;IACb,cAAc;AAClB;;AAEA;IACI,sBAAsB;IACtB,aAAa;AACjB;;AAEA;IACI,aAAa;IACb,uBAAuB;IACvB,mBAAmB;AACvB;;AAEA;IACI,eAAe;IACf,cAAc;;IAEd,aAAa;IACb,uBAAuB;IACvB,uBAAuB;IACvB,SAAS;AACb","sourcesContent":["@import url('https://fonts.googleapis.com/css2?family=Jost&display=swap');\n* {\n    padding: 0;\n    margin: 0;\n}\n\n.body {\n    min-height: 100vh;\n    background-image: url(\"./clem-onojeghuo-zlABb6Gke24-unsplash.jpg\");\n    background-size: cover;\n    color: rgb(255, 255, 255);\n    font-family: \"Jost\", sans-serif;\n    font-size: 1.3rem;\n    font-weight: 550;\n    text-shadow: 4px 4px 2px rgb(0, 0, 0);\n\n    display: grid;\n    grid-template-rows: 40px 1fr 200px;\n    grid-template-columns: minmax(20vw, 300px) 1fr minmax(20vw, 400px);\n}\n\n.grid-search {\n    grid-row: 1;\n    grid-column: 1 / 4;\n\n    display: flex;\n}\n\n.searchForm,\n.location-query-input {\n    display: flex;\n    flex-grow: 1;\n    justify-content: center;\n    align-items: center;\n}\n\n.searchForm {\n    margin: 4px 16px;\n    gap: 16px;\n}\n\n.location-query-input {\n    max-width: 50vw;\n    border: none;\n    outline: none;\n    border-bottom: 2px solid white;\n\n    color: inherit;\n    background: inherit;\n    font-family: inherit;\n    font-size: inherit;\n}\n\n.search-btn {\n    border: none;\n    outline: none;\n    color: inherit;\n    background: inherit;\n    font-size: 1.5rem;\n}\n\n.main-info {\n    grid-row: 2 / 3;\n    grid-column: 1;\n    margin: 16px;\n}\n\n.main-info {\n    padding: 2px 0px;\n}\n\n.display-name-region {\n    font-size: 2rem;\n}\n\n.display-country,\n.date-month-day-year,\n.date-time,\n.display-feels-like,\n.display-degrees {\n    font-size: 1rem;\n}\n\n.display-condition {\n    font-size: 1.75rem;\n}\n\n.display-true-degrees {\n    font-size: 2.5rem;\n}\n\n.toggle-celsius-btn,\n.refresh-btn {\n    border: none;\n    color: inherit;\n    background: inherit;\n    font-size: 1.2rem;\n    padding: 2px;\n}\n\n.toggle-celsius-btn:hover,\n.refresh-btn:hover {\n    outline: 2px solid white;\n}\n\n.aux-info {\n    grid-row: 2;\n    grid-column: 3 / 4;\n    margin: 16px;\n    display: flex;\n    flex-direction:column;\n    align-items: flex-end;\n}\n\n.aux-info > p:first-child {\n    font-size: 1.75rem;\n}\n\n.aux-info > * {\n    padding: 2px 0px;\n}\n\n.aux-info-card {\n    display: flex;\n}\n\n.hourly {\n    grid-row: 3 / 4;\n    grid-column: 1 / 3;\n\n    display: flex;\n    overflow: auto;\n}\n\n.hourly > * {\n    min-width: fit-content;\n    padding: 12px;\n}\n\n.hourly > * > * {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n}\n\n.forecast-info {\n    grid-row: 3 / 4;\n    grid-column: 3;\n\n    display: flex;\n    justify-content: center;\n    align-items: flex-start;\n    gap: 32px;\n}"],"sourceRoot":""}]);
// Exports
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   currentDOM: () => (/* binding */ currentDOM),
...
async function currentDOM(weatherDataPromise) {
    ...
    displayHourly(today.hour, forecastDays[1].hour, (0,date_fns_format__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(weatherData.location.localtime), "H"));
...
function displayCurrentInfo(weatherData, today) {
    ...
    dateMonthDayYear.textContent = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(location.localtime), "LLLL do, y");
    dateTime.textContent = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(location.localtime), "EEEE, h:mm a");
}
...
function displayHourly(hours, tomorrowHours, currentHour) {
    ...
    while(currentHour < 24) {
        ...
        hourTitle.textContent = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(hours[currentHour].time), "h a");
    ...
    while (displayCount < 24) {
        const hourCard = document.createElement("div");
        const hourTitle = document.createElement("p");
        hourTitle.textContent = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(hours[tomorrowHour].time), "h a");
        hourCard.appendChild(hourTitle);
...
function displayForecast(tomorrow, dayafter) {
    tomorrowDate.textContent = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(tomorrow.date), "EEEE");
    dayafterDate.textContent = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(dayafter.date), "EEEE");
...
/***/ "./src/clem-onojeghuo-zlABb6Gke24-unsplash.jpg":
/*!*****************************************************!*\
  !*** ./src/clem-onojeghuo-zlABb6Gke24-unsplash.jpg ***!
  \*****************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "c73e07460fbdf45dc2bc.jpg";
...
/* harmony import */ var _displayDOM_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./displayDOM.js */ "./src/displayDOM.js");
...
toggleCelsiusBtn.addEventListener("click", () => {
    _displayDOM_js__WEBPACK_IMPORTED_MODULE_1__.toggleCelsius();
    _displayDOM_js__WEBPACK_IMPORTED_MODULE_1__.currentDOM(_weather_api_js__WEBPACK_IMPORTED_MODULE_0__.currentWeather());
});

const searchForm = document.querySelector(".searchForm");
const searchInput = document.getElementById("locationQuery");
searchForm.addEventListener("submit", () => {
    _displayDOM_js__WEBPACK_IMPORTED_MODULE_1__.currentDOM(_weather_api_js__WEBPACK_IMPORTED_MODULE_0__.currentWeather(searchInput.value));
    searchForm.reset();
})
